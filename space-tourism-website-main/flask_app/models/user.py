...
class User:
    db_name = "personal" # Replace this with the name of your schema name
    ...
    def __init__(self,data): # data is a DICTIONARY
        ...
        self.cuts = [] # Empty list holding many items for this user, e.g. Recipes; add as many attributes as needed
